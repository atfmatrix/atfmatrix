import { k as t, C as r, h as a } from "./index-BkkCC0vW.js";
...
class l extends t {
  ...
  async download(e, s) {
    ...
    const d = new r();
    e && (d.onmessage = e);
    const o = await a("plugin:updater|download", { onEvent: d, rid: this.rid, ...s });
  ...
  async downloadAndInstall(e, s) {
    i(s);
    const d = new r();
    e && (d.onmessage = e), await a("plugin:updater|download_and_install", { onEvent: d, rid: this.rid, ...s });
  }
  async close() {
...
function i(n) {
  n?.headers && (n.headers = Array.from(new Headers(n.headers).entries()));
}
export {
  l as Update,
  h as check
